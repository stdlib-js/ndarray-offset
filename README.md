...
```javascript
offset = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-offset@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/ndarray-offset/tags). For example,

```javascript
offset = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-offset@v0.2.3-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var offset = require( 'path/to/vendor/umd/ndarray-offset/index.js' )
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/ndarray-offset.svg
[npm-url]: https://npmjs.org/package/@stdlib/ndarray-offset

[test-image]: https://github.com/stdlib-js/ndarray-offset/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/ndarray-offset/actions/workflows/test.yml?query=branch:v0.2.3

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/ndarray-offset/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/ndarray-offset?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/ndarray-offset.svg
[dependencies-url]: https://david-dm.org/stdlib-js/ndarray-offset/main
...
[deno-readme]: https://github.com/stdlib-js/ndarray-offset/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/ndarray-offset/tree/umd
[umd-readme]: https://github.com/stdlib-js/ndarray-offset/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/ndarray-offset/tree/esm
[esm-readme]: https://github.com/stdlib-js/ndarray-offset/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/ndarray-offset/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/ndarray-offset/main/LICENSE
